...
export default class WebViewDetail extends Component {
    ...
    constructor(props){
        ...
        this.state = {
            ...
            isShowLeftBtn:this.props.navigation.state.params.isShowLeftBtn,
            leftBtnTitle:'',
            leftBtnJS:'',
            headerTitle:'',
            isShowRightBtn:this.props.navigation.state.params.isShowRightBtn,
            rightBtnTitle:'',
            rightBtnJS:'',
        }
    ...
    static navigationOptions = ({navigation, screenProps}) => (
        ...
        navigation.state.params.isShowLeftBtn?
        {
        ...
        headerLeft:(
            <Text  onPress={()=>{
                that.leftItemBtnClicked();
                 ...
                 {navigation.state.params.leftBtnTitle.length==0 ?'返回': navigation.state.params.leftBtnTitle}
            </Text>
        ),
        headerRight:(
            <Text  onPress={()=>{
    ...
    _setOnesState= (_arr,callback) => {
        ...
        that.setState({
                isShowLeftBtn:_leftleftBtnJS.length > 0,
